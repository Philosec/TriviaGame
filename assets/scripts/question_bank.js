...
QuestionBank.prototype.initQuestions = function () {
  ...
  this.questionArr.push(new Question('What\'s the distance from earth to moon', '238,900 mi', ['420,000 mi', '383,000 mi', '180,000 mi'], 'assets/images/moon.png'))
  this.questionArr.push(new Question('Number of planets in our solar system', '8', ['7', '9', '10'], 'assets/images/solar-system.png'))
  this.questionArr.push(new Question('Planet with no solid surface', 'Jupiter', ['Mars', 'Earth', 'Mercury'], 'assets/images/2-planets.png'))
